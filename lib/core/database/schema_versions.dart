...
// 手动补充:生成代码引用了 AppDefaults.* 列默认常量,drift schema dump 不会自动加此 import。
// 重新生成 schema_versions.dart 后需重新添加(见 CLAUDE.md → Drift 迁移工具链)。
import 'tables/app_defaults.dart'; // ignore_for_file: depend_on_referenced_packages
